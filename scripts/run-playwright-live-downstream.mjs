...
process.env.QUESTION_STUDIO_GENERATION_CANDIDATE_COUNT = "1";
process.env.PLAYWRIGHT_FORCE_NEW_SERVER = "1";

console.log("Live downstream smoke — startup diagnostics:");
printLiveDiagnostics(repoRoot);
console.log("");

const result = spawnSync(
  "pnpm",
  ["exec", "playwright", "test", "-c", "playwright.live-downstream.config.ts"],
